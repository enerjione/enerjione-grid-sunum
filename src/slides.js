...
export const slides = [
  ...
  },
  {
    ...
    headline: 'Son algılayan cihaz ile ilk\nalgılamayan cihaz arasındaki kesim.',
    body: 'Aranacak alan tüm hat değil, yalnızca bu iki nokta arasıdır. Sistem bu kesimin uzunluğunu ve hangi direkler arasında kaldığını doğrudan verir.',
    overlay: {
      type: 'measure',
      showDim: true,
      cardY: 15,
      ...
      a: { x: 42.6, y: 37.2, state: 'fault', name: 'SON ALGILAYAN', tag: 'ARIZA VAR', sub: 'SN-2.0 · 10412' },
      b: { x: 57.1, y: 37.7, state: 'ok', name: 'İLK ALGILAMAYAN', tag: 'ARIZA YOK', sub: 'SN-2.0 · 10413' },
      dimY: 48,
      zone: 'ARIZA BÖLGESİ',
      distance: '1.6 km',
    },
